...
import { Search, ShoppingBag, Leaf, Truck, Shield, Heart, Star, Sparkles, ArrowRight, MapPin } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link href="/seller" className="text-gray-600 hover:text-green-600">Продавать</Link>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm mb-6">
                <Sparkles className="w-4 h-4" /> Растения для дома
              </div>
              ...
              <div className="relative max-w-md">
                ...
                <input type="text" placeholder="Поиск растений..." className="w-full pl-11 pr-4 py-3 bg-white border border-gray-200 rounded-full focus:outline-none focus:ring-2 focus:ring-green-500" />
              </div>
            ...
            <div className="hidden md:block">
              <div className="bg-gradient-to-br from-green-400 to-emerald-500 rounded-2xl overflow-hidden">
                <img src="https://images.unsplash.com/photo-1466692476868-aef1dfb1e735?w=600" className="w-full" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm">Маркетплейс растений</p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/seller" className="hover:text-white">Личный кабинет</Link></li>
              </ul>
            </div>
            <div>
